...
<head>
	...
	<title>Johan H. Guzman Gil</title>
...
<main class="intro">
	<div class="container-fluid">
		<aside class="text-center">
			<h3>Hola,</h3>
			<h3>Soy Johan Guzman</h3>
			<p>Soy Programador web Freelancer y creador de Ecommerce</p>
		</aside>
...
<section class="service">
	<div class="container">
		<h2 class="text-center title">MIS SERVICIOS</h2>
...
<section class="lestWork">
	<div class="container">
		<h2 class="title">Trabajemos juntos!</h2>
		<p class="text-center">Estoy disponible para proyectos y tiempo completo</p>
	</div>
</section>
